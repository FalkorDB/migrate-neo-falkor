...
def get_neo4j_credentials():
    ...
    user = input(f"Enter Neo4j username (default: {NEO4J_CREDS_USERNAME}): ").strip() or NEO4J_CREDS_USERNAME
    password = input(f"Enter Neo4j password (default: {NEO4J_CREDS_PASSWORD}): ").strip() or NEO4J_CREDS_PASSWORD
