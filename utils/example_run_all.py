...
def main():
    ...
    proceed = input("⚠️  This will reset the environment (delete data on both graphs including constraints and will empty the exported data folder). Continue? [y/N]: ").strip().lower()
    if proceed not in ("y", "yes"):
